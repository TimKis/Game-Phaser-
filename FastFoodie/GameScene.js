...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    gameState.customerCountText = this.add.text(gameState.cam.worldView.right - 20, 80, gameState.totalCustomerCount + ' customers left', { fontSize: '15px', fill: '#000000' }).setOrigin(1);
  ...
  drawStars() {
    ...
    for (let i = 0; i < gameState.starRating; i++) {
      ...
      gameState.starGroup.create(starLocation + (50 * i), 20, 'Star-full').setOrigin(0).setScale(0.5);
    }
  }
